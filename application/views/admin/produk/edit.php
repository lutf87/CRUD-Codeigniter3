                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php base_url(" admin/produk/edit") ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('nama') ? 'is-invalid' : '' ?>" type="text" name="nama" placeholder="Product name" value="<?php echo $produk->nama ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('harga') ? 'is-invalid' : '' ?>" type="number" name="harga" min="0" placeholder="Product price" value="<?php echo $produk->harga ?>" />
                                <div class="invalid-feedback">
